...
import com.example.auth.filter.CsrfCookieFilter;
import com.example.auth.filter.JWTTokenGeneratorFilter;
import com.example.auth.filter.JWTTokenValidatorFilter;
import com.example.auth.filter.RequestValidationBeforeFilter;
...
public class ProjectSecurityConfig {
    ...
    public AuthenticationManager authenticationManager(UserDetailsService userDetailsService,
        ...
        BankUsernamePwdAuthenticationProvider bankUsernamePwdAuthenticationProvider =
